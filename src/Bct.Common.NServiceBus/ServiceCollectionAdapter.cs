// <copyright file="ServiceCollectionAdapter.cs" company="TerumoBCT">
...
{
   internal class ServiceCollectionAdapter : IConfigureComponents
   {
      ...
      private static ServiceLifetime Map(DependencyLifecycle lifetime)
      {
         switch (lifetime)
         {
